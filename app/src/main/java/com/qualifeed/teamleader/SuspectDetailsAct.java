    ...
    public void blockUnblockDialog(String id,String msg){
        ...
        tvYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(NetworkAvailablity.checkNetworkStatus(SuspectDetailsAct.this)) blockUnblockFun(id);
                else Toast.makeText(SuspectDetailsAct.this, getString(R.string.network_failure), Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
